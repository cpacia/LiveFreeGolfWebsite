        ...
        <>
          ...
          <p className="standings-blurb">
            {activeTab === 'season' ? (
              ...
              <>The World Golf Rankings use a different points system than the season standings. Players are ranked based on their results from the last two seasons, with typically a 60% handicap allowance applied to each event score. </>
            )}
          </p>
